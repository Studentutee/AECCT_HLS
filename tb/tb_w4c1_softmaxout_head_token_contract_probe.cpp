...
private:
    ...
    bool run_negative_contract_mismatch_case() {
        ...
        // Keep C1 negative probe aligned to bounded single-token descriptor guard.
        // Force invalid token span to trigger precheck reject before any head writeback executes.
        family_key_token_count[0] = (aecct::u32_t)2u;

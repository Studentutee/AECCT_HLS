...
constexpr float REFV3_SCALE_L0_IN_S_X = 40.336463928222656f;
constexpr float REFV3_SCALE_L0_O_S_X = 110.63162231445312f;
constexpr float REFV3_SCALE_L0_FF1_S_X = 42.850276947021484f;
constexpr float REFV3_SCALE_L0_FF2_S_X = 57.637298583984375f;

constexpr float REFV3_SCALE_L0_ATTN_Q_S_W = 3.4775071144104004f;
constexpr float REFV3_SCALE_L0_ATTN_K_S_W = 3.2122509479522705f;
constexpr float REFV3_SCALE_L0_ATTN_V_S_W = 8.15131664276123f;
constexpr float REFV3_SCALE_L0_ATTN_O_S_W = 10.102375984191895f;
constexpr float REFV3_SCALE_L0_FFN_W1_S_W = 8.694713592529297f;
constexpr float REFV3_SCALE_L0_FFN_W2_S_W = 4.8022541999816895f;

// Reciprocal constants are precomputed to keep synthesis away from fp16 operator/.
constexpr float REFV3_INV_L0_ATTN_Q = 0.0071290908541314845f;
constexpr float REFV3_INV_L0_ATTN_K = 0.0077177856170683968f;
constexpr float REFV3_INV_L0_ATTN_V = 0.00304140610051462f;
constexpr float REFV3_INV_L0_ATTN_O = 0.000894740696358606f;
constexpr float REFV3_INV_L0_FFN_W1 = 0.0026840529927247346f;
constexpr float REFV3_INV_L0_FFN_W2 = 0.0036128608702035883f;
constexpr float REFV3_INV_L1_ATTN_Q = 0.0043993235050510809f;
constexpr float REFV3_INV_L1_ATTN_K = 0.0071688982173430315f;
constexpr float REFV3_INV_L1_ATTN_V = 0.0049903884588218062f;
constexpr float REFV3_INV_L1_ATTN_O = 0.0043067652734030569f;
constexpr float REFV3_INV_L1_FFN_W1 = 0.002454141838255364f;
constexpr float REFV3_INV_L1_FFN_W2 = 0.0055658957032067415f;
constexpr float REFV3_INV_D_MODEL = 0.03125f;

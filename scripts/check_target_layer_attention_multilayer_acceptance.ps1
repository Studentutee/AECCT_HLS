...
$requiredLines = @(
    ...
    "CASE_TARGET1_N3_ATTN_COMPAT_SHELL_OBSERVABILITY target_layer_id=1 n_layers=3 shell_enabled_count=2 shell_disabled_count=1 shell_enabled_last_layer_id=2 shell_disabled_last_layer_id=1 target_shell_disabled_count=1 non_target_shell_enabled_count=2",
    "CASE_TARGET1_N3_ATTN_COMPAT_SHELL_DISABLED PASS",
    "CASE_TARGET1_N3_NON_TARGET_ATTN_COMPAT_SHELL_RETAINS_LEGACY PASS",

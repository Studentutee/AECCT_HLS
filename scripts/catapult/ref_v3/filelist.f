# REF_V3 Catapult experiment track filelist.
# Core design remains single-source under AECCT_ac_ref/include/ref_v3 + src/ref_v3.
AECCT_ac_ref/catapult/ref_v3/ref_v3_catapult_top_entry.cpp

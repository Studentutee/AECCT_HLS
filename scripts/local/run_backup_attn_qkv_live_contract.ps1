...
try {
    ...
    Require-String -LogPath $runLog -Needle 'SCORE_row_head0_token0_exact=1'
    Require-String -LogPath $runLog -Needle 'HEAD0_TOKEN0_UNMASKED_COUNT=1'
    Require-String -LogPath $runLog -Needle 'HEAD0_TOKEN0_CTX_EQUALS_REF_V_EXACT=1'

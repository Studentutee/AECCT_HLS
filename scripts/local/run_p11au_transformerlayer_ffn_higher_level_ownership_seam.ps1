...
try {
    ...
    $requiredPassLines = @(
        ...
        'W1_INPUT_PRELOAD_FALLBACK_NOT_TAKEN_POINTER_PATH PASS',
        'W1_INPUT_PRELOAD_FALLBACK_EXPECTED_POINTER_PATH PASS',
        'W1_WEIGHT_MAINLINE_TAKEN_POINTER_PATH PASS',
        'W1_WEIGHT_PRELOAD_FALLBACK_NOT_TAKEN_POINTER_PATH PASS',
        'W1_WEIGHT_PRELOAD_FALLBACK_EXPECTED_POINTER_PATH PASS',
        'W1_BIAS_MAINLINE_TAKEN_POINTER_PATH PASS',
        'W1_BIAS_PRELOAD_FALLBACK_NOT_TAKEN_POINTER_PATH PASS',
        'W1_BIAS_PRELOAD_FALLBACK_EXPECTED_POINTER_PATH PASS',
        'W1_INPUT_MAINLINE_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W1_INPUT_PRELOAD_FALLBACK_NOT_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W1_INPUT_PRELOAD_FALLBACK_EXPECTED_DEEP_BRIDGE_PATH PASS',
        'W1_WEIGHT_MAINLINE_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W1_WEIGHT_PRELOAD_FALLBACK_NOT_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W1_WEIGHT_PRELOAD_FALLBACK_EXPECTED_DEEP_BRIDGE_PATH PASS',
        'W1_BIAS_MAINLINE_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W1_BIAS_PRELOAD_FALLBACK_NOT_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W1_BIAS_PRELOAD_FALLBACK_EXPECTED_DEEP_BRIDGE_PATH PASS',
        'W2_WEIGHT_MAINLINE_TAKEN_POINTER_PATH PASS',
        'W2_PRELOAD_FALLBACK_NOT_TAKEN_POINTER_PATH PASS',
        'W2_PRELOAD_FALLBACK_EXPECTED_POINTER_PATH PASS',
        'W2_BIAS_MAINLINE_TAKEN_POINTER_PATH PASS',
        'W2_BIAS_PRELOAD_FALLBACK_NOT_TAKEN_POINTER_PATH PASS',
        'W2_BIAS_PRELOAD_FALLBACK_EXPECTED_POINTER_PATH PASS',
        'W2_WEIGHT_MAINLINE_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W2_PRELOAD_FALLBACK_NOT_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W2_PRELOAD_FALLBACK_EXPECTED_DEEP_BRIDGE_PATH PASS',
        'W2_BIAS_MAINLINE_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W2_BIAS_PRELOAD_FALLBACK_NOT_TAKEN_DEEP_BRIDGE_PATH PASS',
        'W2_BIAS_PRELOAD_FALLBACK_EXPECTED_DEEP_BRIDGE_PATH PASS',

...
Require-Regex -Text $softmaxOutText -Pattern '(?ms)case_key_token_begin\s*!=\s*0u\s*\|\|\s*case_key_token_count\s*!=\s*1u' -Reason "SoftmaxOut mainline missing W4-C1 bounded token descriptor guard anchor"

...
| NR-RUNNER-NEXT-PARTIAL-BUCKET-AUDIT-005 | ready | runner | NR-CHECK-DESIGN-PURITY-ACTIVE-004 | runner.local.p11aj | true | Select next safest partial bucket after q-ready/kv-not-prebuilt QKV+SCORES shell cut. | Must emit case-specific PASS banner and preserve fully-prebuilt/out-only/scores-only behavior for already-converged buckets. |

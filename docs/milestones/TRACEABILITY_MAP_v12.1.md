...
| Current project progress | 專案目前狀態已有單點摘要，可快速判讀主線進度與 open items。 | `docs/process/PROJECT_STATUS_zhTW.txt` | `docs/process/PROJECT_STATUS_zhTW.txt` | status summary | 2026-03-16 已補記 P00-011F~P00-011N local acceptance / deferred closure。 |
...
5. 若任務與 ternary live-cut / local smoke 直接相關，再讀 `docs/milestones/P00-011L-A_report.md`、`docs/milestones/P00-011L-B_report.md`、`docs/milestones/P00-011L-C_report.md`、`docs/milestones/P00-011L-D_report.md`、`docs/milestones/P00-011M_report.md`、`docs/milestones/P00-011N_report.md` 與對應 `src/blocks` / `tb` / `scripts` 正式檔。  

## 5. Known Gaps
- m1/m2 runtime closure 尚未正式完成。  
- full numeric closure 尚未完成。  
- live ternary packed payload migration 尚未完成。  
- P00-011J / P00-011K / P00-011L-A / P00-011L-B / P00-011L-C / P00-011L-D / P00-011M / P00-011N 目前僅接受 local smoke scope，Catapult / SCVerify 驗證仍待後續批次執行。  

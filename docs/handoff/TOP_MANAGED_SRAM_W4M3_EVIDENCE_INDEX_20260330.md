# TOP MANAGED SRAM W4-M3 EVIDENCE INDEX (2026-03-30)

## Scope
- W4-M3: Phase-A Q phase-entry caller-fed x-row descriptor probe.
- Local-only evidence bundle:
  - `build/evidence/w4_phasea_q_probe_campaign_20260330/`

## Evidence manifest
- `build/evidence/w4_phasea_q_probe_campaign_20260330/evidence_manifest.txt`
- `build/evidence/w4_phasea_q_probe_campaign_20260330/evidence_summary.txt`
- `build/evidence/w4_phasea_q_probe_campaign_20260330/commands_run.txt`

## Targeted validation
- `build/p11w4m3/phasea_q_phase_entry_probe/build.log`
...
## Hygiene / purity
- `build/evidence/w4_phasea_q_probe_campaign_20260330/logs/check_design_purity.log`
- `build/evidence/w4_phasea_q_probe_campaign_20260330/logs/check_repo_hygiene_pre.log`
- `build/evidence/w4_phasea_q_probe_campaign_20260330/logs/check_repo_hygiene_post.log`

# TOP_MANAGED_SRAM_W4B2_EVIDENCE_INDEX_20260331

## Scope
- local-only evidence bundle for W4-B2 Phase-B QkScore bounded score-tile bridge
- not Catapult closure
- not SCVerify closure

## Primary W4-B2 logs
- `build/p11w4b2/qkscore_tile_bridge/build.log`
- `build/p11w4b2/qkscore_tile_bridge/run.log`
- `build/p11w4b2/qkscore_tile_bridge/verdict.txt`
- `build/p11w4b2/qkscore_tile_bridge/file_manifest.txt`

## Guard/check logs
- `build/top_managed_sram_guard/check_top_managed_sram_boundary_regression.log`
- `build/top_managed_sram_guard/check_top_managed_sram_boundary_regression_summary.txt`
- `build/evidence/w4b2_qkscore_tile_bridge_20260331/check_top_managed_sram_boundary_regression.log`
- `build/evidence/w4b2_qkscore_tile_bridge_20260331/check_helper_channel_split_regression.log`
- `build/evidence/w4b2_qkscore_tile_bridge_20260331/check_design_purity.log`
- `build/evidence/w4b2_qkscore_tile_bridge_20260331/check_repo_hygiene_pre.log`
- `build/evidence/w4b2_qkscore_tile_bridge_20260331/check_repo_hygiene_post.log`

## Regression carry-forward logs
...
- `build/evidence/w4b2_qkscore_tile_bridge_20260331/evidence_summary.txt`

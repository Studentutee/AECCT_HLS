# TOP_MANAGED_SRAM_W4B1_EVIDENCE_INDEX_20260330

## Scope
- local-only evidence bundle for W4-B1 Phase-B bounded tile bridge
- not Catapult closure
- not SCVerify closure

## Primary W4-B1 logs
- `build/p11w4b1/phaseb_tile_bridge/build.log`
- `build/p11w4b1/phaseb_tile_bridge/run.log`
- `build/p11w4b1/phaseb_tile_bridge/verdict.txt`
- `build/p11w4b1/phaseb_tile_bridge/file_manifest.txt`

## Guard/check logs
- `build/top_managed_sram_guard/check_top_managed_sram_boundary_regression.log`
- `build/top_managed_sram_guard/check_top_managed_sram_boundary_regression_summary.txt`
- `build/evidence/w4b1_phaseb_tile_bridge_20260331/check_top_managed_sram_boundary_regression.log`
- `build/evidence/w4b1_phaseb_tile_bridge_20260331/check_helper_channel_split_regression.log`
- `build/evidence/w4b1_phaseb_tile_bridge_20260331/check_design_purity.log`
- `build/evidence/w4b1_phaseb_tile_bridge_20260331/check_repo_hygiene_pre.log`
- `build/evidence/w4b1_phaseb_tile_bridge_20260331/check_repo_hygiene_post.log`
...
- `build/evidence/w4b1_phaseb_tile_bridge_20260331/evidence_summary.txt`

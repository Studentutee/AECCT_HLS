# TOP MANAGED SRAM W4-M1 EVIDENCE INDEX (2026-03-30)

## Scope
- W4-M1: QK-score phase-entry caller-fed descriptor probe.
- Local-only evidence bundle:
  - `build/evidence/w4m1_qkscore_probe_20260330/`

## Evidence manifest
- `build/evidence/w4m1_qkscore_probe_20260330/evidence_manifest.txt`
- `build/evidence/w4m1_qkscore_probe_20260330/evidence_summary.txt`

## Targeted validation
- `build/p11w4m1/qkscore_phase_entry_probe/build.log`
...
## Hygiene / purity
- `build/evidence/w4m1_qkscore_probe_20260330/logs/check_design_purity.log`
- `build/evidence/w4m1_qkscore_probe_20260330/logs/check_repo_hygiene_pre.log`
- `build/evidence/w4m1_qkscore_probe_20260330/logs/check_repo_hygiene_post.log`

...
static const unsigned LN_X_IN_BASE_WORD_DEFAULT = (unsigned)sram_map::X_WORK_BASE_W;
static const unsigned LN_X_OUT_BASE_WORD_DEFAULT = (unsigned)sram_map::X_WORK_BASE_W;
